...
public class TicketCategoryManagementService {
  ...
  public TicketCategoryManagementService(TicketCategoryRepository categories,TicketCategoryVersionRepository versions,
      ...
      ActorContextProvider actors,PlatformClock clock,ObjectMapper mapper){this.categories=categories;this.versions=versions;
    this.mappings=mappings;this.validation=validation;this.uuids=uuids;this.actors=actors;this.clock=clock;this.mapper=mapper;}
